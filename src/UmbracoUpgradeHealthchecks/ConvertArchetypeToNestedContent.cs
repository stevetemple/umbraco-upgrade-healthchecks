...
namespace UmbracoUpgradeHealthchecks
{
	public class ConvertArchetypeToNestedContent
	{
		...
		private IEnumerable<PropertyType> Archetypes(IEnumerable<PropertyType> types, IDataTypeDefinition archetypeDataType)
		{
			return types.Where(a => a.DataTypeDefinitionId == archetypeDataType.Id && a.PropertyEditorAlias == ArchetypeAlias);
		}
	}
}
